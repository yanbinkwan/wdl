(function (node) {
  ...
  var items = function items() {
    ...
    var ins = function ins(selection) {
      fetch("http://localhost:8000/task/list", {
        ...
        selection.append("div").attr("class", "drag-container").selectAll("div").data(tasks).join("div").attr("class", "items").text(function (d) {
  ...
  function Task () {
    ...
    var ins = function ins(selection) {
      ...
      group.selectAll("rect.container").data([null]).join("rect").attr("class", "container").attr("height", 20).attr("width", 20).attr("rx", 2).attr("ry", 2).attr("fill", "#272643");
      group.selectAll("image").data(function (d) {
        return [d];
      }).join("image").attr("xlink:href", node).attr("width", 15).attr("height", 15).attr("x", 2.5).attr("y", 2.5).on("click", function (d, d1) {
        dg.data(d1).showup();
  ...
  var TaskIns = Task().on("link", handleLinkEvent).on("delete", handleTaskDeleteEvent);
  function initSvg() {
  ...
  function loadTasks() {
    select("#app").call(items().on("dragend-g", function (value) {
      var x = value.x,
        y = value.y,
